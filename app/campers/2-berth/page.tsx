            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              ...
              <div className="mb-4">
                <div className="space-y-1.5 text-sm font-body mb-1">
                  <div className="flex justify-between items-baseline"><span className="text-muted">Low season <span className="text-xs">(May–Sep)</span></span><span className="font-bold text-dark">NZ$179/day</span></div>
                  <div className="flex justify-between items-baseline"><span className="text-muted">Shoulder <span className="text-xs">(Oct–Nov, Mar–Apr)</span></span><span className="font-bold text-dark">NZ$219/day</span></div>
                  <div className="flex justify-between items-baseline"><span className="text-muted">High season <span className="text-xs">(Dec–Feb)</span></span><span className="font-bold text-dark">NZ$259/day</span></div>
                </div>
                <p className="font-body text-xs text-muted/70">Minimum 5 days rental</p>
              </div>
              <Link
                href="/book?camper=2-berth"
